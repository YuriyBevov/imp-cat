...
function buildDocumentPrompt(filename, manifest) {
  ...
  return [
    ...
    'Для типографики оцени только размер шрифта, обычное/жирное начертание (fontWeight строго 400 или 700), курсив и выравнивание. Не определяй семейство шрифта, цвет или межстрочный интервал: приложение использует Arial, стандартный цвет и lineHeight=1.2. Не приписывай текст, которого нет на изображении.',
